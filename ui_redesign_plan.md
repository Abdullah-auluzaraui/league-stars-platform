...
*   #### [MODIFY] [src/app/globals.css](file:///c:/Users/abodx/Documents/league-stars/src/app/globals.css)
    ...
    *   إضافة فئات الـ **Glassmorphism** الداكنة الفاخرة:
        ```css
        .glass-panel {
          background: rgba(18, 19, 26, 0.6); /* رمادي داكن فخم */
          backdrop-filter: blur(16px);
          border: 1px solid rgba(0, 71, 255, 0.15); /* حدود زرقاء خفيفة جداً */
          transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
        }
        .glass-panel:hover {
          border-color: rgba(1, 61, 213, 0.5); /* زيادة سطوع الحدود الزرقاء عند التفاعل */
          box-shadow: 0 0 20px rgba(0, 71, 255, 0.1); /* توهج أزرق خافت للغاية */
        }
        ```
    *   إضافة أنيميشن **النبض النيوني الأزرق النابض** للمباريات المباشرة (`@keyframes neon-pulse`).
...
*   #### [MODIFY] [src/app/page.tsx](file:///c:/Users/abodx/Documents/league-stars/src/app/page.tsx) (الصفحة الرئيسية)
    ...
    *   إعادة بناء تخطيط الشبكة بالكامل لتصبح **Bento Grid** متفاعلة:
        *   **Widget 1 (البث المباشر):** شريط أفقي قابل للسحب باللمس (Swipeable Matches Carousel) يعرض مباريات اليوم الجارية بحدود زرقاء نحيفة تتوهج وتنبض ديناميكياً.
        ...
        *   **Widget 2 (الهداف التاريخي):** بطاقة ثلاثية الأبعاد جذابة تعرض متصدر الهدافين مع خلفية وهج ذهبية خفيفة.
